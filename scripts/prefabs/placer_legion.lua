...
----折枝、芽束、种籽的：种成生长状态
CreatePlacer("cutted_rosebush", "berrybush2", "rosebush", "idle", nil, nil, nil, nil, nil, nil, Fn_rosebush)
CreatePlacer("cutted_lilybush", "berrybush2", "lilybush", "idle", nil, nil, nil, nil, nil, nil, Fn_lilybush)
CreatePlacer("cutted_orchidbush", "berrybush2", "orchidbush", "idle", nil, nil, nil, nil, nil, nil, Fn_orchidbush)

----挖起的花丛：种成枯萎状态
CreatePlacer("dug_rosebush", "berrybush2", "rosebush", "dead", nil, nil, nil, nil, nil, nil, Fn_rosebush)
CreatePlacer("dug_lilybush", "berrybush2", "lilybush", "dead", nil, nil, nil, nil, nil, nil, Fn_lilybush)
CreatePlacer("dug_orchidbush", "berrybush2", "orchidbush", "dead", nil, nil, nil, nil, nil, nil, Fn_orchidbush)

----永不凋零
CreatePlacer("neverfade", "berrybush2", "neverfadebush", "idle", nil, nil, nil, nil, nil, nil, Fn_neverfade)
...
----子圭一型岩
CreatePlacer("siving_derivant_item", "siving_derivants", "siving_derivants", "lvl0", nil, nil, nil, nil, nil, nil, Fn_derivant)
