...
local function CopyStrActionFail(newkey, key)
    S______GENERIC.ACTIONFAIL[newkey] = S______GENERIC.ACTIONFAIL[key]
    S_______WILLOW.ACTIONFAIL[newkey] = S_______WILLOW.ACTIONFAIL[key]
    S_____WOLFGANG.ACTIONFAIL[newkey] = S_____WOLFGANG.ACTIONFAIL[key]
    S________WENDY.ACTIONFAIL[newkey] = S________WENDY.ACTIONFAIL[key]
    S_________WX78.ACTIONFAIL[newkey] = S_________WX78.ACTIONFAIL[key]
    S_WICKERBOTTOM.ACTIONFAIL[newkey] = S_WICKERBOTTOM.ACTIONFAIL[key]
    S_______WOODIE.ACTIONFAIL[newkey] = S_______WOODIE.ACTIONFAIL[key]
    S______WAXWELL.ACTIONFAIL[newkey] = S______WAXWELL.ACTIONFAIL[key]
    S___WATHGRITHR.ACTIONFAIL[newkey] = S___WATHGRITHR.ACTIONFAIL[key]
    S_______WEBBER.ACTIONFAIL[newkey] = S_______WEBBER.ACTIONFAIL[key]
    S_______WINONA.ACTIONFAIL[newkey] = S_______WINONA.ACTIONFAIL[key]
    S_______WORTOX.ACTIONFAIL[newkey] = S_______WORTOX.ACTIONFAIL[key]
    S_____WORMWOOD.ACTIONFAIL[newkey] = S_____WORMWOOD.ACTIONFAIL[key]
    S________WARLY.ACTIONFAIL[newkey] = S________WARLY.ACTIONFAIL[key]
    S_________WURT.ACTIONFAIL[newkey] = S_________WURT.ACTIONFAIL[key]
    S_______WALTER.ACTIONFAIL[newkey] = S_______WALTER.ACTIONFAIL[key]
    S________WANDA.ACTIONFAIL[newkey] = S________WANDA.ACTIONFAIL[key]
end
...
CopyStrActionFail("STORE_BEEF_L", "STORE")
CopyStrActionFail("FEED_BEEF_L", "GIVE")
