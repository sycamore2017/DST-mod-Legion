...
STRINGS.NAMES.DISH_WRAPPEDSHRIMPPASTE = "Wrapped Shrimp Paste" --白菇虾滑卷
...
--STRINGS.CHARACTERS.WILLOW.DESCRIBE.PINEANANAS = "Oh! So cute, like my Bernie."
--STRINGS.CHARACTERS.WOLFGANG.DESCRIBE.PINEANANAS = "Wolfgang can eat in one bite!"
--STRINGS.CHARACTERS.WENDY.DESCRIBE.PINEANANAS = "Baby's always so cute, grown one's not."
--STRINGS.CHARACTERS.WX78.DESCRIBE.PINEANANAS = "STICK ADDON INSTALLED"
--STRINGS.CHARACTERS.WICKERBOTTOM.DESCRIBE.PINEANANAS = "Well, isn't that refreshing?"
-- STRINGS.CHARACTERS.WOODIE.DESCRIBE.PINEANANAS = "Hah. Not as funny as Chaplin."
--STRINGS.CHARACTERS.WAXWELL.DESCRIBE.PINEANANAS = "Hm... No Monster child, no future trouble."
--STRINGS.CHARACTERS.WATHGRITHR.DESCRIBE.PINEANANAS = "I've somehow found a way to make it even LESS appealing!"
--STRINGS.CHARACTERS.WEBBER.DESCRIBE.PINEANANAS = "We don't want to grow up, do you?"
-- STRINGS.CHARACTERS.WINONA.DESCRIBE.PINEANANAS = "Neither the Keystone, nor a key thing."
-- STRINGS.CHARACTERS.WORTOX.DESCRIBE.PINEANANAS = "Hey, who dropped this in a snowball fight?"
...
--STRINGS.CHARACTERS.WILLOW.DESCRIBE.PINEANANAS_COOKED = "Oh! So cute, like my Bernie."
--STRINGS.CHARACTERS.WOLFGANG.DESCRIBE.PINEANANAS_COOKED = "Wolfgang can eat in one bite!"
--STRINGS.CHARACTERS.WENDY.DESCRIBE.PINEANANAS_COOKED = "Baby's always so cute, grown one's not."
--STRINGS.CHARACTERS.WX78.DESCRIBE.PINEANANAS_COOKED = "STICK ADDON INSTALLED"
--STRINGS.CHARACTERS.WICKERBOTTOM.DESCRIBE.PINEANANAS_COOKED = "Well, isn't that refreshing?"
-- STRINGS.CHARACTERS.WOODIE.DESCRIBE.PINEANANAS_COOKED = "Hah. Not as funny as Chaplin."
--STRINGS.CHARACTERS.WAXWELL.DESCRIBE.PINEANANAS_COOKED = "Hm... No Monster child, no future trouble."
--STRINGS.CHARACTERS.WATHGRITHR.DESCRIBE.PINEANANAS_COOKED = "I've somehow found a way to make it even LESS appealing!"
--STRINGS.CHARACTERS.WEBBER.DESCRIBE.PINEANANAS_COOKED = "We don't want to grow up, do you?"
-- STRINGS.CHARACTERS.WINONA.DESCRIBE.PINEANANAS_COOKED = "Neither the Keystone, nor a key thing."
-- STRINGS.CHARACTERS.WORTOX.DESCRIBE.PINEANANAS_COOKED = "Hey, who dropped this in a snowball fight?"
...
--STRINGS.CHARACTERS.WILLOW.DESCRIBE.PINEANANAS_SEEDS = "Oh! So cute, like my Bernie."
--STRINGS.CHARACTERS.WOLFGANG.DESCRIBE.PINEANANAS_SEEDS = "Wolfgang can eat in one bite!"
--STRINGS.CHARACTERS.WENDY.DESCRIBE.PINEANANAS_SEEDS = "Baby's always so cute, grown one's not."
--STRINGS.CHARACTERS.WX78.DESCRIBE.PINEANANAS_SEEDS = "STICK ADDON INSTALLED"
--STRINGS.CHARACTERS.WICKERBOTTOM.DESCRIBE.PINEANANAS_SEEDS = "Well, isn't that refreshing?"
-- STRINGS.CHARACTERS.WOODIE.DESCRIBE.PINEANANAS_SEEDS = "Hah. Not as funny as Chaplin."
--STRINGS.CHARACTERS.WAXWELL.DESCRIBE.PINEANANAS_SEEDS = "Hm... No Monster child, no future trouble."
--STRINGS.CHARACTERS.WATHGRITHR.DESCRIBE.PINEANANAS_SEEDS = "I've somehow found a way to make it even LESS appealing!"
--STRINGS.CHARACTERS.WEBBER.DESCRIBE.PINEANANAS_SEEDS = "We don't want to grow up, do you?"
-- STRINGS.CHARACTERS.WINONA.DESCRIBE.PINEANANAS_SEEDS = "Neither the Keystone, nor a key thing."
-- STRINGS.CHARACTERS.WORTOX.DESCRIBE.PINEANANAS_SEEDS = "Hey, who dropped this in a snowball fight?"
