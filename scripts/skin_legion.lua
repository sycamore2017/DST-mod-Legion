...
_G.SKINS_LEGION = {
    ...
    fishhomingtool_awesome_thanks = {
        ...
        string = ischinese and {
            ...
            description = "“书接上回，扶伤剑护主而断，这消息不知怎地不胫而走，而江湖上现今又流传着一个新的消息，说这食铁兽的遗孤已然认扶伤剑持剑者为主，现名浮生儿。而今扶伤剑再无护主能力，那这食铁兽是否会易主就成了众人茶余饭后最大的谈资。就看这京城一隅的一方小小茶楼，几人正悄声低语着浮生儿的最新消息，却是各不相同，几人各执一词。殊不知，这茶楼屋顶有一男子头戴斗笠手持一奇形烟斗吞云吐雾，只见他嘴角扯起一抹不屑的笑容，抬手招来黑色大鸟，将一卷密信放入鸟脚信筒。至此，这浮生儿被捉进京都衙门内的消息便如同长了翅膀一样飞了出去。当夜丑时，衙门内除了个别看门打盹的官兵一片寂然，突然后院传来悉悉索索的异响。‘哼，上钩了’仔细瞧那墙角黑雾中，一名颓郁男子摘下斗笠，而他身周的云雾似乎有了感应，翻涌得愈发诡谲。这便是，江湖人心难餍足，云烟缭绕不肯渡！”",
        } or {
    ...
    rosebush_collector = {
        ...
        string = ischinese and {
            ...
            description = "用尽毕生精力，终于在极其遥远的星云残骸中找到传说中能贯穿星辰的神剑。当他自豪地在高台上举起这把闪耀神剑，剑体却很快碎裂化作无数金色闪光向地面射去。众人诧异之下，地面开始干枯龟裂，水晶般的荆棘开始在整个星球蔓延。",
        } or {
    ...
    siving_turn_collector = {
        ...
        string = ischinese and {
            ...
            description = "\"我想我...已经对你，...倾慕已久，沐歌\"。\"飞船失控，在这片星漩中已徘徊七个月，无数次望向你，都是那么无暇那么熠熠生辉...总能带给我希望...\"。‘来吧...来吧...投入我的怀抱...’。在飞船靠近沐歌星时，从舱口跳出一个身影，很快便被卷入星环之中。",
        } or {
