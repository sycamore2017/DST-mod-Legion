...
configuration_options = L and {
    ...
    {   name = "ShieldKey",
        label = "Shortcut Key for Lifting Shield",
        hover = "Set the shortcut Key for shield lifting action.",
        options = {
            ...
            {description = "L(default)", data = 108},
